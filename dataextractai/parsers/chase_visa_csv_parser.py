...
class ChaseVisaCSVParser(BaseParser):
    """
    Parser for Chase Visa CSV exports.
    """

    name = "chase_visa_csv"
    description = "Parser for Chase Visa CSV exports."
    file_types = [".csv"]
    ...
    def parse_file(
        ...
        df["post_date"] = df["Post Date"].apply(self.parse_date)
...
def main(input_path: str) -> ParserOutput:
    """
    Canonical entrypoint for contract-based integration. Parses a single Chase Visa CSV and returns a ParserOutput.
    ...
    try:
        ...
        metadata = StatementMetadata(
            statement_date=None,  # Chase Visa CSV does not have a statement date field
