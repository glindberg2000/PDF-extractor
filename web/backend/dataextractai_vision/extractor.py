...
class VisionExtractor:
    ...
    # Model configuration
    MODEL_NAME = "gpt-4-vision-preview"  # The latest version that works with vision
    MAX_TOKENS = 1500
    TEMPERATURE = 0
    ...
    def process_pdf(self, pdf_path: str, output_dir: str = None) -> Optional[str]:
        ...
        try:
            ...
            # Create output directory if it doesn't exist and was provided
            if output_dir:
            ...
            if all_transactions:
                ...
                csv_path = os.path.join(
                    output_dir or os.path.dirname(pdf_path),
                    ...
                    [
                        {
                            ...
                            "amount": t.amount,
                            "category": t.category,
                            "raw_text": f"Page {t.page_number}: {t.description}",
                        }
