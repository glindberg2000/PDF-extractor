"""
SearXNG Search API Integration

This module provides functionality to search the web using the SearXNG API.
It's designed to be used as a tool for web search functionality.

Rate Limits:
    Default: 1 request per second (1 QPS)
    To handle rate limits:
    - Add delays between requests (time.sleep(1))
    - Catch 429 errors and implement backoff
    - Consider caching results for frequently searched queries

Usage:
    from tools.searxng_search import search_web, format_search_results
    ...
    formatted = format_search_results(results, "python programming")
    print(formatted)

Environment Variables Required:
    SEARXNG_HOST: Your SearXNG instance host (default: http://localhost:8080)
"""
